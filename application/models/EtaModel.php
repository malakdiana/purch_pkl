...
class EtaModel extends CI_Model {
    ...
    public function __construct()
    {
     ...
     public function getPo($tgl){
		...
		$this->db->select('bayangan.id_bayangan, bayangan.id_po,bayangan.id_pr,bayangan.id_item,po.supplier,po.tgl_po,po.no_po,po.eta,po.franco,purch_req.section,purch_req.pr_no,bayangan.item,item.unit_name,bayangan.qty , eta.konfirmasi, eta.invoice, eta.remarks');
		//$this->db->select('*');
