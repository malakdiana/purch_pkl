...
<div class="card">
         <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-4"> <div class="row"><input autocomplete="on" type="text" name="material" id="rupiahmat" class="form-control" style="width: 250px"><p> &nbsp;&nbsp;x&nbsp;&nbsp; </p><input autocomplete="on" type="number" name="qtymat" class="form-control" style="width: 60px" placeholder="qty" value="1">
              </div>
            </div>
          </div>
           <div class="row">
            ...
            <div class="col-sm-4"> <br><div class="row"><br><br><input autocomplete="on" type="text" name="jasa" id="rupiahjas" class="rupiah form-control" style="width: 250px"><p> &nbsp;&nbsp;x&nbsp;&nbsp; </p><input autocomplete="on" type="number" name="qtyjas" class="form-control" style="width: 60px" placeholder="qty" value="1">
              </div>
           ...
           <div class="row">
            ...
            <div class="col-sm-4"> <br><div class="row"><input autocomplete="on" type="number" name="pph" class="form-control" style="width: 60px;"> &nbsp;&nbsp;<font size="5px">%</font></div>
