      ...
      $.ajax({
          ...
          dataType: 'json',  
                    ...
                    document.getElementById('qtysisa').value = data.qty;  
                     ...
                     document.getElementById('rupiah').value = data.harga;
