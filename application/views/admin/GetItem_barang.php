                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="dataTablesss">
                                        ...
                                        $no =1; foreach ($Purch_req as $key) {?>
                                            <tr>
                                                ...
                                                <button type="button" class="btn btn-danger" style="width:80px; height:50px;"><a href="<?php echo site_url()?>/Purch_req/deleteItem/<?php echo $id?>/<?php echo $key->id_item?> " onclick="return confirm('Apakah Yakin Untuk Menghapus?')"><font color="white"><i class="fa fa-trash-o"></i> Hapus</font></a></button>

                                                  <button type="button" class="btn btn-success" style="width:115px; height:50px;"><a href="<?php echo site_url()?>/Po/InsertPo/?>"><font color="white"><i class="fa fa-arrow-right"></i> Insert to Po</font></a></button>
</td>
