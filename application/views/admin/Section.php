                        ...
                        <?=$this->session->flashdata('editSection')?>
                         ...
                         <?=$this->session->flashdata('tambahSection')?>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" id="dataTablesss">
                                    ...
                                    <button type="button" class="btn btn-primary">  <a href="javascript:void(0);" onclick="modalDetail('<?php echo $key->id_section?>','<?php echo $key->nama_section ?>','<?php echo $key->dept ?>')"  data-toggle="modal" data-target="#myModalEdit"><font color="white">Edit</font></a></button>
                                    <button type="button" class="btn btn-danger">  <a href="<?php echo site_url()?>/Section/deleteSection/<?php echo $key->id_section?> " onclick="return confirm('Apakah Yakin Untuk Menghapus?')"><font color="white">Hapus</font></a></button>
