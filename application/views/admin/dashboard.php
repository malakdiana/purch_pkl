                                 ...
                                 <table cellpadding="0" cellspacing="0" border="0" class="table">
                                        <thead class="bg-light text-capitalize" align="center" >
                                         ...
                                         <tr>
                                                ...
                                                <h5><th align="left" style="margin-right: 35px;"><img style="width: 40px;height: 50px;" src="<?php echo base_url()?>assets/images/icon/icondata.png"> DATA</h5></th>
                                        </tr>
                                        ...
                                        <tr align="center">
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                 <a href="<?php echo site_url()?>/Riwayatdatang/"><button class="btn btn-flat btn-info mb-4" role="button" style="width:175px""><img style="width: 100px;height: 100px" src="<?php echo base_url()?>assets/images/icon/histori.png"><br>RIWAYAT KEDATANGAN</button></a><br>
                                                 </td>
                                    ...
                                    <table align="left" style="margin-top:-20px;" >
                                          <tr style="">
                                                       <td >
                                                       <a href="<?php echo site_url()?>/Login/ManajemenUser"><button class="btn btn-flat btn-info mb-4" role="button" style="width:160px; margin-left:55px"><img style="width: 100px;height: 100px" src="<?php echo base_url()?>assets/images/icon/user.png"><br>KELOLA USER</button></a><br></td>
