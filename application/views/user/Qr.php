                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-responsive table-striped" id="dataTablesss">
                                        ...
                                        <?php   foreach ($Qr as $key) {?>
                                            ...
                                            <td></td>
                                                ...
                                                <td> <a href="<?php echo site_url()?>/Qr/GetItem_barang/<?php echo $key->id?>"><i class="fw-icons fa fa-clone"></i></a></td>

                                                <td>
                                                <a href="<?php echo site_url()?>/Qr/tambahItem/"><i class="fa fa-edit"></i></a></td>
                                                <td>                                          
                                                <a href="<?php echo site_url()?>/Qr/deleteQr/<?php echo $key->id?> " onclick="return confirm('Apakah Yakin Untuk Menghapus?')"><i class="fa fa-trash-o"></i></a></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 800px; margin-left: -100px;padding: 20px" >
                <div class="modal-header">
                    <h4 class="modal-title">Info Qr</h4>
                </div>
          <?php echo form_open_multipart('Qr/tambahItem'); ?>
