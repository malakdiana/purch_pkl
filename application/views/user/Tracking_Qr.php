                                            ...
                                            <tr>
                                                ...
                                                <?php if($key->status ==  0){?>
                                                 ...
                                                 <?php } else{?>
                                                  ...
                                                  <div class="btn-group mb-xl-3" role="group" aria-label="Basic example">
                                                   <a href="<?php echo site_url()?>/Qr/detailQuotationUser/<?php echo $key->id_penawaran?>">   <?php if ($status_chat==0){ ?>
                                                    <button type="button" class="btn btn-info" style="width:80px; height:45px;"><font color="white"><i class="fa fa-th-list"></i> Detail</font></button></a>
                                                  <?php   }else{ ?>
                                                      <button type="button" class="btn btn-info" style="width:80px; height:45px;"><font color="white"><i class="fa fa-commenting-o"></i> Detail</font></button></a>
                                                    <?php   } ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 800px; margin-left: -100px;padding: 20px" >
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">EDIT QR</h4>
